...
def argparser():
	...
	parser.add_argument('-st', '--softmax_T', metavar = 'T', type = float, default = 1.0, help = 'might improve exploration; softmax temperature 2.0, 2.2 and 1.5 might yield better results')
	parser.add_argument('-s', '--steps', metavar = 'S', type = int, default = 10000, help = 'training steps(epochs)')
