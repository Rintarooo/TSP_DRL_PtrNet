...
def argparser():
	...
	parser.add_argument('--seed', metavar = 'SEED', type = int, default = 1, help = 'random seed number')
	...
	parser.add_argument('-c', '--clip_logits', metavar = 'C', type = int, default = 10, help = 'clipping logits')
	...
	parser.add_argument('-ap', '--act_model_path', metavar = 'AMP', type = str, default = './Pt/0510_act.pt', help = 'actor load model path')
...
class Config():
	def __init__(self,**kwargs):	
		...
		self.pkl_path = './Pkl/%s.pkl'%self.mode
